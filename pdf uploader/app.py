            ...
            for page_number, page in enumerate(pdf.pages, start=1):
                ...
                if text:
                    ...
                    for line_number, line in enumerate(lines, start=1):
                        ...
                        # Insert or update AcademicYear table
                        cursor.execute("""
                        ...
                        # Skip grades like "F" or "ABSENT"
                        if grade in ("F", "ABSENT"):
                            continue

                        # Insert or update sub_table
                        cursor.execute("""
                        ...
                        # Insert or update student_table
                        cursor.execute("""
                        ...
                        # Insert or update year_sem table
                        for i in range(4):
                            year_entry = year + i
                            year_code = f"{academic_id}{i + 1}{branch}"
